...
class EmployeeNewView extends React.Component {
  ...
  handleSubmit = async (e) => {
    ...
    if (
      ...
      if (EmpType !== 1 || (EmpType === 1 && ContractStartDate && ContractEndDate)) {
        let postData = {
          EmpCode,
          EmpName,
          Address,
          ...
          ResignDate:
            typeof ResignDate === "object" ? ResignDate?.[0] : editData?.ResignDate,
        ...
        await history.push("/data-list/employee-view");
      }
    }
  };
        ...
        <Card>
          <CardHeader>
            ...
            <Button
              size="sm"
              color="primary"
              onClick={() => history.push("/data-list/employee-view")}
            >
                  ...
                  <>
                    <Col sm="3">
                      ...
                      <Flatpickr
                        ...
                        className={`form-control form-control-sm ${
                          btnFlg && !this.state.ContractStartDate ? "invalid-input" : ""
                        }`}
                      />
                    ...
                    <Col sm="3">
                      ...
                      <Flatpickr
                        ...
                        className={`form-control form-control-sm
                          ${
                            btnFlg && !this.state.ContractEndDate ? "invalid-input" : ""
                          }`}
                      />
