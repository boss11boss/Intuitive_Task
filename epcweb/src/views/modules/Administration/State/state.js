...
class StateView extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    // }
    // if (this.props.dataList.error !== prevProps.dataList.error) {
    //   toast.error(this.props.dataList.error);
    //   this.setState({
    //     error: this.props.dataList.error,
    //   });
    // }
            ...
            <Form className="country">
              <FormGroup row className="align-items-center">
                <Col
                  sm="2"
                  className={
                    btnFlg && this.state.CountryID === 0 ? "invalid-input" : ""
                  }
                >
                  <Label>Country</Label>
                  {/* <Select
