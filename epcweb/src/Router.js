...
const RouteConfig = ({ component: Component, fullLayout, ...rest }) => {
  ...
  // if (currentTime > localStorage.getItem("Token_expire")) {
  //   // localStorage.clear();
  //   history.push("/login");
  // }
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          <AppRoute path="/data-list/city-view" component={cityView} />
          <AppRoute path="/data-list/district-view" component={districtView} />
          <AppRoute path="/data-list/card-view" component={cardView} />
          <AppRoute
            path="/data-list/supplier-view"
            component={supplierView}
            exact
          />
          <AppRoute
            path="/data-list/supplier-view/new"
            component={supplierNewView}
            exact
          />
          <AppRoute
            path="/data-list/supplier-view/edit/:id"
            component={supplierNewView}
            exact
          />
          <AppRoute path="/data-list/location-view" component={locationView} />
          <AppRoute
            path="/data-list/designation-view"
            component={designationView}
          />
          <AppRoute
            path="/data-list/project-view"
            component={projectView}
            exact
          />
          <AppRoute path="/data-list/item-view" component={itemView} exact />
          <AppRoute
            path="/data-list/item-view/new"
            component={itemNewView}
            exact
          />
          <AppRoute
            path="/data-list/item-view/edit/:id"
            component={itemNewView}
            exact
          />
          <AppRoute
            path="/data-list/vehicle-view"
            component={vehicleView}
            exact
          />
          <AppRoute
            path="/data-list/vehicle-view/new"
            component={vehicleNewView}
            exact
          />
          <AppRoute
            path="/data-list/vehicle-view/edit/:id"
            component={vehicleNewView}
            exact
          />
          <AppRoute
            path="/data-list/employee-view"
            component={employeeView}
            exact
          />
          <AppRoute
            path="/data-list/employee-view/new"
            component={employeeNewView}
            exact
          />
          <AppRoute
            path="/data-list/employee-view/edit/:id"
            component={employeeNewView}
            exact
          />
          <AppRoute
            path="/data-list/user-view"
            component={userDataView}
            exact
          />
          <AppRoute
            path="/data-list/user-view/new"
            component={userNewDataView}
            exact
          />
          <AppRoute
            path="/data-list/user-view/edit/:id"
            component={userNewDataView}
            exact
          />
          <AppRoute path="/data-list/room-view" component={roomView} exact />
          <AppRoute
            path="/data-list/room-view/new"
            component={roomNewView}
            exact
          />
          <AppRoute
            path="/data-list/room-view/edit/:id"
            component={roomNewView}
            exact
          />
          <AppRoute
            path="/data-list/project-view/new"
            component={projectNewView}
            exact
          />
          <AppRoute
            path="/data-list/project-view/edit/:id"
            component={projectNewView}
            exact
          />
          <AppRoute path="/data-list/role-view" component={roleView} exact />
          <AppRoute
            path="/data-list/add-role-view"
            component={addRoleView}
            exact
          />
          <AppRoute
            path="/data-list/role-view/edit/:id"
            component={addRoleView}
            exact
          />

          <AppRoute path="/data-list/country-view" component={countryView} />
          <AppRoute path="/data-list/state-view" component={stateView} />
          ...
          {/* custom Routes */}
          <AppRoute path="/PurchaseIndent" component={PurchaseIndent} exact />
          <AppRoute
            path="/PurchaseIndent/new"
            component={PurchaseIndentNew}
            exact
          />
          <AppRoute
            path="/PurchaseIndent/edit/:id"
            component={PurchaseIndentNew}
            exact
          />
          <AppRoute path="/PurchaseOrder" component={PurchaseOrder} exact />
          <AppRoute
          ...
          <AppRoute
            ...
            exact
          />
          <AppRoute path="/GRN" component={GRN} exact />
          <AppRoute path="/GRN/new" component={GRNNew} exact />
          <AppRoute path="/GRN/edit/:id" component={GRNNew} exact />
          <AppRoute path="/PurchaseBill" component={PurchaseBill} />
