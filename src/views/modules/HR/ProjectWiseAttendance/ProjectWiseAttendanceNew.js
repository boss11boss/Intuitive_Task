...
import "../../style.css";
import {
  getProjectWiseAttendance,
  addProjectWiseAttendance,
  getProjectWiseAttendanceDropDown,
...
class ProjectWiseAttendanceNew extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.getProjectWiseAttendanceDropDown(postData);
    this.props.getProjectWiseAttendance(postData);
  }
  ...
  handleSubmit = async (e) => {
    ...
    if (AccountGroup && AccountName) {
      ...
      if (history?.location?.state?.id) {
        await this.props.addProjectWiseAttendance({
          ...itemData,
          ...postData,
        });
      } else {
        await this.props.addProjectWiseAttendance(postData);
      }
      await this.resetState();
      await history.push("/HR/ProjectWiseAttendance");
    }
  };
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Card>
          <CardHeader>
            <CardTitle>Project Wise Attendence</CardTitle>
            <Button
              size="sm"
              color="primary"
