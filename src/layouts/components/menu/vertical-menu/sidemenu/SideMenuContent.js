...
//             // let index = navigationData.findIndex(
//             //   (x) => x.title === subData.GroupCode
//             // );
//             // let link = "/" + subData.FunName;
...
//             // navigationData[index].children.push({
...
//     navigationData[0].children.push({
//       id: 122,
//       title: "Role Master",
//       type: "item",
//       navLink: "/data-list/role-view",
//       icon: <Icon.List size={20} />,
//     });
//     const menuItems = navigationData.map((item) => {
